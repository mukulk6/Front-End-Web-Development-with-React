                ...
                <div className="col-12 col-md-9">
                    <Form model ="feedback" onSubmit={(values)=>this.handleSubmit(values)}>
                        <Row className="form-group">
                            ...
                            <Col md={10}>
                                <Control.text model=".firstname" className="form-control" type="text" id="firstname" name="firstname" placeholder="First Name" validators={{required,minLength:minLength(3),maxLength:maxLength(15)}}
                                        />
                        ...
                        <Row className="form-group">
                            ...
                            <Col md={10}>
                                <Control.textarea model=".message" id="feedback" name="email" rows="12" className="form-control" />                       
                            </Col>
                        </Row>
                        <Row className="form-group">
